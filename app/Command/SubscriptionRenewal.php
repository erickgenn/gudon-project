...
class SubscriptionRenewal extends BaseCommand
{
    ...
    public function run(array $params)
    {
        $email = \Config\Services::email();
            ...
            $email->setTo('vincentsukamto0311@gmail.com');
                                            ...
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                ...
                                                <tbody style="font-family: Roboto, sans-serif;">
                                                    ...
                                                    <td style="line-height: 24px; font-size: 16px; margin: 0; padding: 16px;" align="left">
                                                        ...
                                                        <p style="font-size: 1.8vmin; line-height: 24px; width: 100%; margin: 0;" align="left">Hello  Erick, Your GuDon account subscription is about to end! Please click the button below to extend your subscription.</p>
                                                        <br>
