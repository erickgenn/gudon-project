...
class EmailService extends BaseService
{
    ...
    public function subscriptionEmail() {        
        $email = \Config\Services::email();
            ...
            $email->setTo(['erick.gennady@merkleinnovation.co.id','vincentsukamto0311@gmail.com']);
                                            ...
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                ...
                                                <tbody style="font-family: Roboto, sans-serif;">
                                                    ...
                                                    <td style="line-height: 24px; font-size: 16px; margin: 0; padding: 16px;" align="left">
                                                        ...
                                                        <p style="font-size: 1.8vmin; line-height: 24px; width: 100%; margin: 0;" align="left">Hello  Erick, Your GuDon account has just requested a password change, please click the button below to continue</p>
                                                        <br>
                                                        <table class="btn" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <a  style="font-size: 2vh; background-color: #5cc5e6; color: #FFFFFF; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; padding: 8px 12px; border: 1px solid transparent;">
                                                                    Reset Your Password
                                                                </a>
                                                                </td>
                                                            </tr>
