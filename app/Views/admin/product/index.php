...
<div class="wrapper">
  ...
  <?php endif; ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12">
          <?php if($admin_data['not_assigned']):?>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Not Assigned Product</h3>
              </div>
              <div class="card-body table-responsive">
                <table id="not-assigned-product-table" class="table table-hover text-nowrap" style="width:100%">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Product Name</th>
    ...
    $('#product-table').DataTable( {
      ...
      "columns": [
        ...
        },
        {
          ...
          render: function(data, type, row, meta){
            return `
            <a href="<?php echo base_url('admin/product/view');?>/${row.id_produk}" style="background-color:#5cc5e6;color:white;" class="btn"><i class="fas fa-edit"></i></a>
            `;
          }
        }
      ]
    });
    $('#not-assigned-product-table').DataTable( {
      "ajax": {
          "url": "<?php echo base_url('admin/product/search/not_assigned'); ?>",
          "dataSrc": ""
      },
      "columns": [
        { "data": "id_produk" },
