...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <select class="form-control" id="customer_id" name="cust_id" style="height:100%;">
                                                    <option selected value="0">ALL</option>
                                                </select>
                                            </div>
                                        </div>
                ...
                $('#report-table').DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            sortable: false,
                            render: function(data, type, row, meta) {
                                return `<a href="<?php echo base_url('admin/report/view') ?>/${row.id}" class="btn" style="background-color:#5cc5e6; color:white;"><i class="fas fa-eye"></i></a>`;
                            }
                        },
                    ]
                });
    ...
    <script>
        $(document).ready(function() {
            $('#report-table').DataTable({
                "ajax": {
                    "url": "<?php echo base_url('admin/report/searchAll'); ?>",
                    "dataSrc": ""
                },
                dom: 'Bfrtip',
                buttons: [{
            ...
            $('#customer_id').select2({
                ...
                ajax: {
                    dataType: 'json',
                    url: '<?php echo base_url("admin/report/searchCust"); ?>',
